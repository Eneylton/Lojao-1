...
foreach ($listar as $item) {
    ...
    $res .= '   <tr>
                 ...
                 <td style="width:350px">' . date('d/m/Y à\s H:i:s', strtotime($item->data)) . '</td>
                 <td style="width:350px">R$ ' . number_format($valor_m,"2",",",".")  . '</td>
...
<table style="margin-top: -40px;">
        <tbody>
            <tr style="background-color: #fff; color:#000">
                ...
                <td style="text-align:center; font-weight:600; font-size:16px; border:1px solid #fff;"><p>***** Mão de obra *****</p><span>Mecânico: <?php echo $mecanico ?></span> 
    ...
    <table>
        <tbody>
            <tr style="background-color:#dd5c00; color:#fff">
                <td style="text-align: center; text-transform:uppercase" colspan="8">LISTA DETALHADA DE MÃO DE OBRA</td>
            </tr>
