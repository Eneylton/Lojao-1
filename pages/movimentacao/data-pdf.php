...
if($categoria_id == ""){
    ...
    $var4 = " AND m.catdesp_id=".$categoria_id."";
}
...
if($mecanicos_id == ""){
    ...
    $var5 = " AND m.mecanicos_id=".$mecanicos_id."";
}


$consulta = "m.data between '".$dataInicio."' AND '".$dataFim."
                                            ' AND m.status =".$var1."
                                              AND m.tipo = " .$var2. " " .$var3. " " .$var4. " " .$var5. " ";

Login::requireLogin();

$result = "";

$listar = Movimentacao ::getData($consulta, 'm.id desc',null);
