...
?>
<body class="hold-transition sidebar-closed sidebar-collapse light-mode layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <i class="far fa-bell" style="font-size:x-large;"></i>
            <span class="badge badge-warning navbar-badge" style="font-size: 17px;"><?= $total ?></span>
          </a>
