      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="pages/compras/compra-list.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Compras</p>
              </a>
            </li>
        ...
        <li class="nav-item menu-close">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="pages/mecanicos/mecanicos-list.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Mecanicos</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="pages/marcas/marca-list.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Marcas</p>
              </a>
            </li>
        ...
        <li class="nav-item menu-close">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="pages/catdesp/catedesp-list.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Categoria Despesas</p>
              </a>
            </li>
